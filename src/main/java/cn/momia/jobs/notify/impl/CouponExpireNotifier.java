...
public class CouponExpireNotifier implements Notifier {
    ...
    public void notifyUser() {
        LOGGER.info("coupon expired notifier started...");
        ...
        try {
            ...
            if (userCouponsToExpired.size() > 1000) {
                ...
                LOGGER.info("{} user coupons are about to expired", userCouponsToExpired.size());
            }
            ...
            LOGGER.info("coupon expired notifier finished");
        }
    }
}
